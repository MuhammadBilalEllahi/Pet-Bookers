...
export const RefundHandle = ({navigation}) => {
  ...
  const fetchRefunds = async () => {
    try {
      ...
      Alert.alert(t('common.error'), t('common.failedToFetchRefunds'));
    } finally {
      setLoading(false);
    }
  };
  ...
  const fetchRefundDetails = async orderDetailsId => {
    try {
      ...
      Alert.alert(t('common.error'), t('common.failedToFetchRefundDetails'));
    }
  };
  ...
  const handleStatusUpdate = async () => {
    if (!selectedStatus || !statusNote.trim()) {
      Alert.alert(t('common.error'), t('common.pleaseSelectStatusAndAddNote'));
      return;
    }
    ...
    try {
      ...
      Alert.alert(
        t('common.success'),
        t('common.refundStatusUpdatedSuccessfully'),
      );
    ...
    <Layout
      ...
      <ScrollView style={styles.scrollView}>
        <Text
          ...
          {t('common.refundRequests')} ({refunds.length})
        </Text>
        ...
        {refunds.length === 0 ? (
          <Card
            ...
            <Text
              ...
              {t('common.noRefundRequestsFound')}
            </Text>
          </Card>
        ) : (
            ...
            return (
              <Card
                ...
                <Text
                  ...
                  {t('common.requested')}: {formatDate(refund.created_at)}
                </Text>
              </Card>
            );
          })
            ...
            <ScrollView style={styles.modalScroll}>
              {refundDetails ? (
                <>
                    ...
                    {refundDetails.data && (
                      <View style={styles.detailRow}>
                        ...
                        <Text
                          ...
                          {refundDetails.data.f_name}{' '}
                          {refundDetails.data.l_name}
                        </Text>
                      </View>
                    )}
                  </Card>
                  ...
                  {refundDetails.refund_request &&
                    refundDetails.refund_request.length > 0 && (
                      <Card style={styles.detailCard}>
                        <Text
                          style={[
                            styles.detailTitle,
                  ...
                  refundDetails.refund_request.length > 0 ? (
                        ...
                        <View key={index} style={styles.historyItem}>
                          ...
                          {request.status === 'pending' && request.message && (
                            <Text
                              ...
                              {t('common.pendingNote')}: {request.message}
                            </Text>
                          )}
                    ...
                    <Card style={styles.detailCard}>
                      ...
                      <Text
                        ...
                        {t('common.noRefundHistoryAvailable')}
                      </Text>
                    </Card>
                  )}
          ...
          <View
            ...
            <View style={styles.statusForm}>
              ...
              <Input
                ...
                placeholder={t('common.enterNoteForStatusUpdate')}
                value={statusNote}
              ...
              <View style={styles.buttonRow}>
                ...
                <Button
                  ...
                  disabled={
                    updatingStatus || !selectedStatus || !statusNote.trim()
                  }
