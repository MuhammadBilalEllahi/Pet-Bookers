...
export const SellerVerifyOTPScreen = ({navigation}) => {
  ...
  const submitForm = async values => {
    try {
      ...
      const response = await axiosSellerClient.post('auth/verify-otp', formData, {
        headers: {
  ...
  const resendOTP = async () => {
    try {
      ...
      const response = await axiosSellerClient.post('auth/forgot-password', formData, {
        headers: {
          'Content-Type': 'multipart/form-data',
        },
      });
