  ...
  return (
    <ScrollView>
      <Layout style={styles.container}>
        {/* Title */}
        <Text style={styles.header}>Choose Payment</Text>

        {/* Progress Bar */}
        <View style={styles.progressRow}>
          <View style={styles.progressStepActive}>
            <Icon name="person-outline" fill="#43a047" style={styles.progressIcon} />
          </View>
          <View style={styles.progressLineActive} />
          <View style={styles.progressStepActive}>
            <Icon name="shopping-bag-outline" fill="#43a047" style={styles.progressIcon} />
          </View>
          <View style={styles.progressLineActive} />
          <View style={styles.progressStepActive}>
            <Icon name="credit-card-outline" fill="#43a047" style={styles.progressIcon} />
          </View>
        </View>
        ...
        <TextInput
          ...
          placeholder="Please enter easypaisa account number"
          value={account}
...
const styles = StyleSheet.create({
  ...
  progressStepActive: {
    width: 38, height: 38, borderRadius: 19, backgroundColor: "#fff", borderWidth: 2, borderColor: "#43a047", alignItems: "center", justifyContent: "center"
  },
